...
const PostoForm = ({ initialData, stati }: PostoFormProps) => {
    ...
    const onSubmit = async (data: PostoFormValues) => {
        try {
            setLoading(true);
            if (!initialData) {
                await axios.post(`/api/${params.accountId}/discoteche/${params.discotecaId}/impost/sale/${params.salaId}/tavoli/${params.tavoloId}/posti`, data);
            } else {
                await axios.patch(`/api/${params.accountId}/discoteche/${params.discotecaId}/impost/sale/${params.salaId}/tavoli/${params.tavoloId}/posti/${params.postoId}`, data)
            }
            router.refresh();
