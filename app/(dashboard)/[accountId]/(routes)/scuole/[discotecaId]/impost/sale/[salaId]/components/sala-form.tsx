...
import { Accounts, Data, Discoteca, Informazione, Piano, Posizione, Provincia, Sala, Stato, Tavolo, TipoInformazione } from '@prisma/client'
                    ...
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue
                            defaultValue={field.value}
                            placeholder="Seleziona il piano"
                          />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                        {piani.map((piano) => (
                          <SelectItem key={piano.id} value={piano.id}>
                            {piano.nome}
                          </SelectItem>
                        ))}
                      </SelectContent>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    ...
                    <Button
                      ...
                      type="button"
                      onClick={() =>
                        field.onChange([...field.value, { data: new Date() }])
                      }
                    >
                      Aggiungi
                    </Button>
