...
const formSchema = z.object({
  ...
  caparra: z.boolean(),
  visibile: z.boolean(),
  ticketCommission: z.coerce.number().min(0).max(100), // Commissione in percentuale per i biglietti
  tableCommission: z.coerce.number().min(0).max(100),
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 md:gap-5'">
            ...
            <div className="grid grid-cols-1 grid-row-2 justify-center items-center w-[102%]">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Commissione Biglietti (%):</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        disabled={loading || !superior}
              ...
              {/* Campo per la commissione dei tavoli */}
              <FormField
                control={form.control}
                name="tableCommission"
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Commissione Tavoli (%):</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        disabled={loading || !superior}
