...
const InformazioneForm = ({
  initialData,
  tipoinformazione,
}: InformazioneFormProps) => {
  ...
  const description = initialData
    ...
    : "Crea l'informazione da far vedere nella visualizzazione della discoteca";
  const toastMessage = initialData
    ? "L'informazione è stata modificata"
    : "L'informazione è stata creata";
  ...
  const onSubmit = async (data: InformazioneFormValues) => {
    try {
      ...
      if (!initialData) {
        await axios.post(
          `/api/${params.accountId}/discoteche/${params.discotecaId}/impost/informazioni`,
          data
        );
      } else {
        await axios.patch(
