...
const CellAction = ({ data, }: CellActionProps) => {
    ...
    const onCopy = (id: string) => {
        ...
        toast.success("Portata Id è stato copiato")
    }
        ...
        <>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => router.push(`/${params.accountId}/discoteche/${params.discotecaId}/impost/menus/${params.menuId}/impost/portate/${data.id}`)}>
